...
function unpackUVsFromRGB(color4) {
  const [u, v, fracUV] = color4;
...
var LineLayer = class extends import_core7.Layer {
  ...
  getShaders() {
    return super.getShaders({ vs: line_layer_vertex_glsl_default, fs: line_layer_fragment_glsl_default, source: shaderWGSL, modules: [import_core7.project32, import_core7.color, import_core7.picking, lineUniforms] });
  }
  // This layer has its own wrapLongitude logic
  get wrapLongitude() {
    return false;
...
var PointCloudLayer = class extends import_core8.Layer {
  getShaders() {
    return super.getShaders({
      ...
      modules: [import_core8.project32, import_core8.color, import_shadertools.gouraudMaterial, import_core8.picking, pointCloudUniforms]
    });
  }
  initializeState() {
...
var ScatterplotLayer = class extends import_core9.Layer {
  getShaders() {
    return super.getShaders({
      ...
      modules: [import_core9.project32, import_core9.color, import_core9.picking, scatterplotUniforms]
    });
  }
  initializeState() {
    this.getAttributeManager().addInstanced({
...
var TextLayer = class extends import_core22.CompositeLayer {
  ...
  initializeState() {
    ...
    if (this.props.maxWidth > 0) {
      import_core22.log.once(1, "v8.9 breaking change: TextLayer maxWidth is now relative to text size")();
    }
  }
