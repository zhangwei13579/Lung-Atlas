...
`;
  ...
  var LineLayer = class extends import_core8.Layer {
    ...
    getShaders() {
      return super.getShaders({ vs: line_layer_vertex_glsl_default, fs: line_layer_fragment_glsl_default, source: shaderWGSL, modules: [import_core8.project32, import_core8.color, import_core8.picking, lineUniforms] });
    }
    // This layer has its own wrapLongitude logic
    get wrapLongitude() {
      return false;
...
`
  ...
  function convertColor(colorDef = {}) {
    const { color: color4 = [0, 0, 0], intensity = 1 } = colorDef;
    return color4.map((component) => component * intensity / COLOR_FACTOR);
  }
  ...
  var PointCloudLayer = class extends import_core10.Layer {
    getShaders() {
      return super.getShaders({
        ...
        modules: [import_core10.project32, import_core10.color, gouraudMaterial, import_core10.picking, pointCloudUniforms]
      });
    }
    initializeState() {
