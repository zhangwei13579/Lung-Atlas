 ...
 */
export type Position = Readonly<[number, number]> | Readonly<[number, number, number]> | Readonly<Float32Array> | Readonly<Float64Array>;
/** A color in the format of `[r, g, b, a?]` */
export type Color = Readonly<[number, number, number]> | Readonly<[number, number, number, number]> | Readonly<Uint8Array> | Readonly<Uint8ClampedArray>;
