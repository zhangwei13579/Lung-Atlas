...
export declare const LightTheme: {
    ...
    readonly '--menu-background': "#fff";
    readonly '--menu-backdrop-filter': "unset";
    readonly '--menu-border': "unset";
    readonly '--menu-shadow': "0px 0px 8px 0px rgba(0, 0, 0, 0.25)";
    readonly '--menu-text': "rgb(24, 24, 26, 1)";
    readonly '--menu-item-hover': "rgba(0, 0, 0, 0.08)";
};
export declare const DarkTheme: {
    ...
    readonly '--menu-gap': "4px";
    readonly '--menu-background': "rgba(18, 18, 20, 1)";
    readonly '--menu-backdrop-filter': "unset";
    readonly '--menu-border': "unset";
    readonly '--menu-shadow': "0px 0px 8px 0px rgba(0, 0, 0, 0.25)";
    readonly '--menu-text': "rgb(215, 214, 229, 1)";
    readonly '--menu-item-hover': "rgba(255, 255, 255, 0.1)";
};
export declare const LightGlassTheme: {
    ...
    readonly '--icon-compass-south-color': "rgb(204, 204, 204)";
    readonly '--menu-gap': "4px";
    readonly '--menu-background': "rgba(255, 255, 255, 0.6)";
    readonly '--menu-backdrop-filter': "blur(4px)";
    readonly '--menu-border': "1px solid rgba(255, 255, 255, 0.6)";
    readonly '--menu-shadow': "0px 0px 8px 0px rgba(0, 0, 0, 0.25), 0px 0px 8px 0px rgba(0, 0, 0, 0.1) inset";
    readonly '--menu-text': "rgb(24, 24, 26, 1)";
    readonly '--menu-item-hover': "rgba(0, 0, 0, 0.08)";
};
export declare const DarkGlassTheme: {
    ...
    readonly '--icon-compass-south-color': "rgb(200, 199, 209)";
    readonly '--menu-gap': "4px";
    readonly '--menu-background': "rgba(18, 18, 20, 0.75)";
    readonly '--menu-backdrop-filter': "blur(4px)";
    readonly '--menu-border': "1px solid rgba(18, 18, 20, 0.75)";
    readonly '--menu-shadow': "0px 0px 8px 0px rgba(0, 0, 0, 0.25), 0px 0px 8px 0px rgba(0, 0, 0, 0.1) inset";
    readonly '--menu-text': "rgb(215, 214, 229, 1)";
    readonly '--menu-item-hover': "rgba(255, 255, 255, 0.1)";
};
