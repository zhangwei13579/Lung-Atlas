...
var __exports__ = (() => {
  ...
  var DropdownMenu = (props) => {
    ...
    return /* @__PURE__ */ u2("div", { className: "deck-widget-dropdown-container", ref: dropdownRef, style: props.style, children: [
      /* @__PURE__ */ u2("button", { className: "deck-widget-dropdown-button", onClick: toggleDropdown, children: /* @__PURE__ */ u2("span", { className: `deck-widget-dropdown-icon ${isOpen ? "open" : ""}` }) }),
      isOpen && /* @__PURE__ */ u2("ul", { className: "deck-widget-dropdown-menu", children: props.menuItems.map((item) => {
  ...
  var GeocoderWidget = class extends import_core7.Widget {
    ...
    onRenderHTML(rootElement) {
      ...
      B(
        /* @__PURE__ */ u2("div", { className: "deck-widget-geocoder", children: [
          /* @__PURE__ */ u2(
            "input",
            {
          ...
          /* @__PURE__ */ u2(DropdownMenu, { menuItems, onSelect: this.handleSelect }),
          this.geocodeHistory.errorText && /* @__PURE__ */ u2("div", { className: "deck-widget-geocoder-error", children: this.geocodeHistory.errorText })
        ] }),
        rootElement
      );
    }
